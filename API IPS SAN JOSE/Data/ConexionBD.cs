...
namespace API_IPS_SAN_JOSE.Data
{
    public class ConexionBD
    {
        ...
        private bool AbrirConexion()
        {
            try
            {
                strCadenaCnx = "Data Source=DESKTOP-2Q32BKK\\SQLEXPRESS;Initial Catalog = DB_API_Sistema_Especializado_Servicio_De_Salud_1; Integrated Security = True";
